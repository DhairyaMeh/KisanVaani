...
from agents.kisan_agent.kisan_agent_wrapper import (
    process_message as kisan_process_message,
    process_image_message as kisan_process_image_message,
)
...
class KisanAIAgent:
    ...
    def __init__(self):
        # Use the lightweight wrapper functions to avoid heavy imports during tests
    ...
    async def process_message(self, 
        ...
        try:
            ...
            return await kisan_process_message(
                message=message,
                user_id=user_id,
    ...
    async def process_image_message(self, 
        ...
        try:
            ...
            return await kisan_process_image_message(
