    ...
    setState(() {
      _messages.add(Message(
        content: widget.selectedLanguage == 'kn'
            ? 'ನಮಸ್ಕಾರ! ಕೃಷಿಕವಾಣಿ ಗೆ ಸ್ವಾಗತ। ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?'
            : widget.selectedLanguage == 'hi'
                ? 'नमस्ते! किसानवाणी में आपका स्वागत है। आज मैं आपकी कैसे मदद कर सकता हूं?'
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.language_outlined, color: AppTheme.accentBlue),
              title: Text('हिन्दी'),
              subtitle: Text('हिन्दी में बदलें'),
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('भाषा हिन्दी में बदल दी गई'),
                    backgroundColor: AppTheme.primaryGreen,
                    duration: Duration(seconds: 2),
                  ),
                );
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text(
              currentLanguage == 'kn' ? 'ಕೃಷಿ ಮಿತ್ರ ಬಗ್ಗೆ' : 'About KisanVaani',
              style: currentLanguage == 'kn'
                  ? AppTheme.kannadaHeading.copyWith(fontSize: 18)
