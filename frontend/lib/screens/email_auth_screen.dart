      ...
      child: TextFormField(
        ...
        inputFormatters: keyboardType == TextInputType.emailAddress
            ...
            : keyboardType == TextInputType.phone
                ...
                : obscureText // Password fields - allow all characters
                    ? null // No input formatters for password fields
                    : [FilteringTextInputFormatter.allow(RegExp(r'[a-zA-Z\s]'))], // Name fields
        style: TextStyle(
                  ...
                  _buildTextField(
                    ...
                    validator: (value) {
                      ...
                      if (_isSignUp && value.length < 6) {
                        return isKannada 
                            ? 'ಪಾಸ್‌ವರ್ಡ್ ಕನಿಷ್ಠ 6 ಅಕ್ಷರಗಳು ಇರಬೇಕು' 
                            : isHindi
