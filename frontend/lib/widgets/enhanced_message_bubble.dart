...
class EnhancedMessageBubble extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (message.hasAudio && !isUser) ...[
                          SizedBox(height: 8),
                          _buildAudioPlayButton(context, currentLanguage),
                        ],
  ...
  Widget _buildAudioPlayButton(BuildContext context, String currentLanguage) {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          currentLanguage == 'kn' 
              ...
              : currentLanguage == 'hi'
                  ? 'क्या आप इस संदेश को क्लिपबोर्ड में कॉपी करना चाहते हैं?'
          ...
          children: [
            ...
            Text(
              currentLanguage == 'kn' 
                  ...
                  : currentLanguage == 'hi'
                      ? 'संदेश क्लिपबोर्ड में कॉपी किया गया'
